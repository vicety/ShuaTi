...
# from theano.tensor import shared_randomstreams  # 随机值
...
def load(filename):
    ...
    data = json.load(f)
    f.close()
    cost = getattr(sys.modules[__name__], data["cost"])  # 用str找class
